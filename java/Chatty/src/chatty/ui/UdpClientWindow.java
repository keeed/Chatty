...
import chatty.network.UdpClient;
import chatty.network.UdpServer;
 ...
 */
public class UdpClientWindow extends javax.swing.JFrame implements ILogger {
    ...
    private void initComponents() {
        ...
        textfieldServerPort.setText("3500");
        ...
        textfieldClientPort.setText("3000");
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(buttonConfigure, javax.swing.GroupLayout.PREFERRED_SIZE, 85, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void buttonConfigureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonConfigureActionPerformed
        ...
        synchronized (criticalSection) {
            try {
                ...
                client = new UdpClient(ipAddress, port, this);

                if (client.Connect()) {
                    Log("UdpClient", "Connected to " + ipAddress + ":" + port);
